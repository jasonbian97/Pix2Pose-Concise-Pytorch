...
class pix2pose():
    def __init__(self,weight_fn,camK,res_x,res_y,obj_param,th_ransac=3.0,th_outlier=[0.1,0.2,0.3],th_inlier=0.1,box_size=1.5,dist_coeff=None,backbone="paper",**kwargs):
        ...
        if(backbone=='paper'):
            ...
            self.generator_train.load_weights(weight_fn) #TODO: load model weight
    ...
    def est_pose(self,rgb,bbox,gt_trans=np.eye((4)),z_iter=False):
        ...
        # ======================================== Stage One =========================================
        decode,prob = self.generator_train.predict( np.expand_dims(input_img,axis=0)) #TODO: What's the meaning of 2 outputs?
